        ...
        <div class="form-group {{$errors->has('image') ? 'has-error' : ''}}">
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-preview thumbnail" data-trigger="fileinput">
                    <img src="{{$post->exists() && $post->image ? '/blog-images/'.$post->image : 'https://placehold.it/430x250&text=Selecione+Uma+Imagem'}}"
                         style="width: 100%;max-height: 228px; ">
                </div>
                <div>
                     <span class="btn btn-default btn-file"><span class="fileinput-new">Procurar</span><span
    ...
    <div class="col-md-8">
        <div class="row">
            ...
            <div class="col-md-4 form-group {{$errors->has('slug') ? 'has-error' : ''}}">
                ...
                <input type="text" value="{{old('slug',$post->exists() ? $post->slug : '')}}" name="slug"
                       class="form-control"
            ...
            <div class="col-md-3 form-group {{$errors->has('status') ? 'has-error' : ''}}">
                ...
                <select class="form-control" name="status">
                    <option value="0" {{$post->exists() ? $post->status == 0 ? 'selected' : '' : null}}>Rascunho
                    </option>
