        ...
        <div class="row">
            <div class="col-md-4 form-group {{$errors->has('name') ? 'has-error' : ''}} ">
                ...
                <input type="text" class="form-control {{$errors->has('name') ? 'is-invalid' : ''}}"
                       value="{{old('name',$oka6Client->exists() ? $oka6Client->name : '')}}" name="name"
                       id="name" placeholder="">
                @if($errors->has('name'))
            ...
            <div class="col-md-4 form-group {{$errors->has('email') ? 'has-error' : ''}}">
                ...
                <input type="email" value="{{old('email',$oka6Client->email)}}" name="email"
            ...
            <div class="col-md-4 form-group {{$errors->has('cellphone') ? 'has-error' : ''}}">
                ...
                <input type="text" value="{{old('cellphone',$oka6Client->exists() ? $oka6Client->cellphone : '')}}"
                       name="cellphone"
            ...
            <div class="col-md-4 form-group {{$errors->has('active') ? 'has-error' : ''}}">
                ...
                <select type="text" name="active" class="form-control {{$errors->has('active') ? 'is-invalid' : ''}}"
                    ...
                    <option value="0" {{$oka6Client->exists() && $oka6Client->active == 0 ? 'selected' : ''}}>
                        Desativado
                    </option>
                </select>
            ...
            <div class="col-md-4 form-group {{$errors->has('user_id') ? 'has-error' : ''}}">
                ...
                @if($user->profile_id==\Oka6\Admin\User::PROFILE_ID_ROOT)
                    <select type="text" name="user_id" class="form-control {{$errors->has('type') ? 'is-invalid' : ''}}"
                            id="user_id">
                    ...
                    <input type="hidden"
                           value="{{$oka6Client->exists() && $oka6Client->user_id ? $oka6Client->user_name : ''}}"
                           name="user_name" class="form-control" id="user_name">
                @else
                    <input type="text" value="{{$user->name}}" name="user_name" class="form-control" id="user_name"
                           readonly>
            ...
            <div class="col-md-4 form-group {{$errors->has('logo') ? 'has-error' : ''}}">
                ...
                <div class="input-group">
                    ...
                    @if($oka6Client->exists() && $oka6Client->logo)
                        <img src="{{$oka6Client->logo}}" alt="user" class="rounded-circle" width="40" height="40"
            ...
            <div class="col-md-4 form-group {{$errors->has('domain') ? 'has-error' : ''}}">
                ...
                <input type="text" value="{{old('domain',$oka6Client->exists() ? $oka6Client->domain : '')}}"
                       name="domain"
            ...
            <div class="col-md-4 form-group {{$errors->has('address_street') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('address_street',$oka6Client->exists() ? $oka6Client->address_street : '')}}"
                       name="address_street"
            ...
            <div class="col-md-4 form-group {{$errors->has('address_number') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('address_number',$oka6Client->exists() ? $oka6Client->address_number : '')}}"
                       name="address_number"
            ...
            <div class="col-md-4 form-group {{$errors->has('address_complement') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('address_complement',$oka6Client->exists() ? $oka6Client->address_complement : '')}}"
            ...
            <div class="col-md-4 form-group {{$errors->has('address_neighborhood') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('address_neighborhood',$oka6Client->exists() ? $oka6Client->address_neighborhood : '')}}"
            ...
            <div class="col-md-4 form-group {{$errors->has('address_city') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('address_city',$oka6Client->exists() ? $oka6Client->address_city : '')}}"
                       name="address_city"
            ...
            <div class="col-md-4 form-group {{$errors->has('address_state') ? 'has-error' : ''}}">
				...
				<?php
	            use Carbon\Carbon;$estadosBrasileiros = array(
					'AC' => 'Acre',
					'AL' => 'Alagoas',
					'AP' => 'Amapá',
					'AM' => 'Amazonas',
				...
				?>
                <select type="text" name="address_state"
                        class="form-control {{$errors->has('address_state') ? 'is-invalid' : ''}}" id="address_state"
                        placeholder="Estado">
            ...
            <div class="col-md-4 form-group {{$errors->has('type') ? 'has-error' : ''}}">
                ...
                <select type="text" name="type" class="form-control {{$errors->has('type') ? 'is-invalid' : ''}}"
                        id="type" placeholder="Cliente">
                    <option value="CPF" {{$oka6Client->exists() && $oka6Client->type == 'CPF' ? 'selected' : ''}}>Pessoa
                        Física
                    </option>
                    <option value="CNPJ" {{$oka6Client->exists() && $oka6Client->type == 'CNPJ' ? 'selected' : ''}}>
                        Pesoa Júridica
                    </option>
                </select>
                @if($errors->has('type'))
            ...
            <div class="col-md-4 form-group {{$errors->has('social_reason') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('social_reason',$oka6Client->exists() ? $oka6Client->social_reason : '')}}"
                       name="social_reason"
            ...
            <div class="col-md-4 form-group {{$errors->has('fantasy_name') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('fantasy_name',$oka6Client->exists() ? $oka6Client->fantasy_name : '')}}"
                       name="fantasy_name"
            ...
            <div class="col-md-4 form-group {{$errors->has('state_register') ? 'has-error' : ''}}">
                ...
                <input type="text"
                       value="{{old('state_register', $oka6Client->exists() ? $oka6Client->state_register : '')}}"
                       name="state_register"
            ...
            <div class="col-md-4 form-group {{$errors->has('plan_id') ? 'has-error' : ''}}">
                ...
                <select type="text" name="plan" class="form-control {{$errors->has('plan_id') ? 'is-invalid' : ''}}"
                        id="plan">
            ...
            <div class="col-md-4 form-group {{$errors->has('plan_id') ? 'has-error' : ''}}">
                ...
                <select type="text" name="type_send_sms"
                        class="form-control {{$errors->has('type_send_sms') ? 'is-invalid' : ''}}" id="type_send_sms">
                    <option value="api" {{$oka6Client->exists() && $oka6Client->type_send_sms == 'api' ? 'selected' : ''}}>
                        Api
                    </option>
                    <option value="client" {{$oka6Client->exists() && $oka6Client->type_send_sms == 'client' ? 'selected' : ''}}>
                        Client
                    </option>
                </select>
            ...
            <div class="col-md-4 form-group {{$errors->has('automatic_remember_sms') ? 'has-error' : ''}}">
                ...
                <select type="text" name="automatic_remember_sms"
                        class="form-control {{$errors->has('automatic_remember_sms') ? 'is-invalid' : ''}}"
                        id="automatic_remember_sms">
                    <option value="1" {{$oka6Client->exists() && $oka6Client->automatic_remember_sms == 1 ? 'selected' : ''}}>
                        Sim
                    </option>
                    <option value="0" {{$oka6Client->exists() && $oka6Client->automatic_remember_sms == 0 ? 'selected' : ''}}>
                        Nao
                    </option>
                </select>
            ...
            <div class="col-md-4 form-group {{$errors->has('automatic_remember_email') ? 'has-error' : ''}}">
                ...
                <select type="text" name="automatic_remember_email"
                        class="form-control {{$errors->has('automatic_remember_email') ? 'is-invalid' : ''}}"
                        id="automatic_remember_email">
                    <option value="1" {{$oka6Client->exists() && $oka6Client->automatic_remember_email == 1 ? 'selected' : ''}}>
                        Sim
                    </option>
                    <option value="0" {{$oka6Client->exists() && $oka6Client->automatic_remember_email == 0 ? 'selected' : ''}}>
                        Nao
                    </option>
                </select>
                    ...
                    <div class="card bg-cyan">
                        <div class="d-flex flex-row">
                            <div class="text-white align-self-center p-10">
                                <h3 class="m-b-0">
                                    R$ {{$oka6Client->last_payment_value ? $oka6Client->last_payment_value : '0,00'}}</h3>
                ...
                <div class="col-md-3 form-group">
                    <div class="card bg-cyan">
                        <div class="d-flex flex-row">
                            <div class="text-white align-self-center p-10">
                                <h3 class="m-b-0">
                                    R$ {{$oka6Client->total_charging ? $oka6Client->total_charging : '0,00'}}</h3>
...
<div class="card">
    <div class="card-header bg-amber">
        <h6 class="m-b-0 text-black font-weight-bolder">Api <a data-toggle="collapse" href="#collapseExample"
                                                               role="button" aria-expanded="false"
                                                               aria-controls="collapseExample"
                                                               class="btn btn-primary m-l-20"><i class="fa fa-key"></i></a>
        </h6>
    </div>
    <div class="card-body collapse" id="collapseExample">
        <label for="state_register">Access Key</label>
        <input type="text" readonly="readonly"
               value="{{old('api_key', $oka6Client->exists() ? $oka6Client->api_key : '')}}" name="api_key"
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" value="" name="cellPhoneUser" class="form-control" id="cellPhoneUser"
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer" style="padding-left: 0;">
                    <div class="row" style="width: 100%">
                        <div class="col-md-12 text-right">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                            <button type="button" id="savePay" class="btn btn-success" data-id="{{$oka6Client->id}}">
                                Solicitar
                            </button>
                        </div>
                    </div>
