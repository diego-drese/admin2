            ...
            <div id="formWizard" class="tab-wizard wizard-circle">
                ...
                <section>
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control required" id="type" name="location"
                                aria-invalid="true">
                        ...
                        <label id="type-error" class="text-danger" for="type" style="display: none">Esse campo é
                            obrigátório.</label>
                    </div>
                </section>
                <!-- Step 2 -->
                ...
                <section>
                    <div class="form-group">
                        ...
                        <select class="custom-select form-control required" id="clients" name="clients"
                                aria-invalid="true" multiple>
                            <option value="all">Todos</option>
                            @foreach($clients as $client)
                                <option value="{{$client->id}}">{{$client->name}}</option>
                            @endforeach
                        </select>
                        <label id="clients-error" class="text-danger" for="type" style="display: none">Esse campo é
                            obrigátório.</label>
                    </div>

                    <div class="form-group">
                        <label for="users"> Usuários: <span class="danger">*</span> </label>
                        <select class="custom-select form-control required" id="users" name="users" aria-invalid="true"
                                disabled multiple>
                            <option value="all">Todos</option>
                        </select>
                        <label id="users-error" class="text-danger" for="type" style="display: none">Esse campo é
                            obrigátório.</label>
                    </div>
