    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class=" mt-2 mt-md-0 buttons">
                <button class="login"><i class="fas fa-user-circle"></i>Entrar</button>
                <button class="login"><i class="fa fa-arrow-right"></i>Começar</button>
    ...
    <div class="bg-home" id="home">
        <div class="container">
            <div class="call-to-action">
                <div>
                    <h1 class="head-title">Apenas um texto headline para teste e tals</h1>
    ...
    <div class="container-fluid margin-top-medium">
        ...
        <div class="row">
            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link tabstyle" id="dashboard-ss-tab" data-toggle="pill" href="#dashboard-ss"
                       role="tab" aria-controls="dashboard-ss" aria-selected="false">Dashboard</a>
                </li>
            </ul>
        </div>
        ...
        <div class="container">
            <div class="tab-content" id="pills-tabContent">
                ...
                <div class="tab-pane fade" id="cadastros-ss" role="tabpanel" aria-labelledby="cadastros-ss-tab">
                    <div class="nav-tab-gal"><a href="#">
                        <img class="card-img"
                             src="https://via.placeholder.com/640x480/f2f2f2/808080?text=Imagem Cadastros" alt=""></a>
                    </div>
                </div>
                <div class="tab-pane fade" id="resumo-ss" role="tabpanel" aria-labelledby="resumo-ss-tab">
                    <div class="nav-tab-gal"><a href="#">
                        <img class="card-img"
                             src="https://via.placeholder.com/640x480/f2f2f2/808080?text= Resumo Agendamentos"
                             alt=""></a>
                    </div>
                </div>
                <div class="tab-pane fade" id="dashboard-ss" role="tabpanel" aria-labelledby="dashboard-ss-tab">
                    <div class="nav-tab-gal"><a href="#!">
                        <img class="card-img"
                             src="https://via.placeholder.com/640x480/f2f2f2/808080?text=Imagem Dashboard" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
...
<div class="container">
    <section class="call">
        ...
        <div>
            <button class="register">Iniciar <i class="icon fas fa-arrow-right"></i></button>
        </div>
    </section>
</div>
 ...
 */
@import url("https://fonts.googleapis.com/css?family=Noto+Sans+HK:900|Lato|Open+Sans:400,600&display=swap");
:root {
  --blue:#007bff;
  --indigo:#6610f2;
  --purple:#6f42c1;
...
.head-title {
  animation: fader 0.3s linear 0s;
  animation-fill-mode: both; }

.head-paragraph {
  animation: fader 0.5s linear 0.3s;
  animation-fill-mode: both; }

.register {
  animation: scale 0.7s linear 0.5s;
  animation-fill-mode: both; }
...
.menu {
  ...
  .menu .nav-item.active > a {
    color: #44b9f7 !important;
    transition: color ease-in 0.3s; }
  .menu .buttons {
    display: flex; }
    .menu .buttons button {
      margin-right: 12px; }
  .menu .navbar-collapse.collapse.show, .menu .navbar-collapse.collapsing {
    background: #fbfbfb;
    padding: 12px; }
  .menu-logo {
    font-family: passion-one, sans-serif;
    margin-right: 20px;
    background: linear-gradient(to right, #9572db, #a184da);
  ...
  .menu-buttons {
    ...
    width: 100%;
    justify-content: space-between; }
    .menu-buttons .calltoaction {
      background: linear-gradient(50deg, #9974eb, #6c68fd);
      padding: 9px 15px;
      border: 0;
      border-radius: 3px;
      margin-left: 20px;
      color: white; }
    .menu-buttons .item-menu {
      text-decoration: none;
      margin-right: 12px;
      font-size: 1.95em;
      color: #576275;
...
.menu-onscroll {
  background: #fff;
  box-shadow: 0px 0px 1rem rgba(54, 54, 56, 0.15); }
...
.footer-links {
  ...
  .footer-links .logo {
    ...
    .footer-links .logo svg {
      margin-right: 6px;
      color: rgba(87, 98, 117, 0.65);
      font-size: 1.2em;
      cursor: pointer; }
  .footer-links .cls ul {
    list-style: none; }
    .footer-links .cls ul li {
      font-size: 1.4em;
      color: rgba(128, 128, 128, 0.82);
      cursor: pointer; }
  .footer-links .cls .title {
    font-family: "Noto Sans HK", sans-serif;
    margin-bottom: 15px; }
...
.feature {
  ...
  .feature .featured-headline {
    ...
    align-content: center;
    text-align: center; }
    .feature .featured-headline h1 {
      margin-bottom: 10px; }
    .feature .featured-headline p {
      font-size: 2em;
      text-align: center; }
...
footer {
  ...
  footer:before {
    ...
    display: block;
    width: 100%;
    clip-path: ellipse(53% 80% at 50% 119%);
    background: #f2f2f2;
    height: 4rem;
    margin-top: -53px;
    left: 0; }
...
.simple-card-icon {
  text-align: center;
  padding: 15px;
  box-shadow: 0px 3px 6px rgba(234, 234, 234, 0.98);
  border-radius: 10px;
  min-height: 175px;
  margin-top: 16px;
  display: flex;
...
.gallery {
  ...
  .gallery .bg-svg {
    ...
    position: absolute;
    width: 100%; }
    .gallery .bg-svg path:nth-child(1) {
      fill: rgba(160, 130, 218, 0.1); }
    .gallery .bg-svg path:nth-child(2) {
      fill: #f5f2fb; }
    .gallery .bg-svg path:nth-child(3) {
      fill: #ccbef6; }
  .gallery .nav-tab-gal {
    position: relative;
    margin: 5px auto;
    ...
    border-radius: 5px;
    animation: openGal ease-in 0.3s;
    -webkit-backface-visibility: visible;
    backface-visibility: visible; }
  .gallery .nav-link.tabstyle {
    font-size: 1.5em;
    padding: 6px 23px;
    border: 1px solid rgba(151, 136, 183, 0.3);
    border-radius: 20px;
    color: #9a74ec;
    font-weight: bold;
    margin-right: 7px; }
    .gallery .nav-link.tabstyle.active {
      background-color: rgba(68, 185, 247, 0.18);
      color: #44b9f7 !important;
      border: 1px solid #d9edf9 !important; }
  .gallery .nav-tab-gal img {
    max-width: 100%;
    z-index: 22;
    position: relative;
    border-radius: 5px;
    box-shadow: 0px 9px 5px rgba(0, 0, 0, 0.2); }
  ...
  .gallery:after {
    ...
    left: 0;
    width: 100%;
    clip-path: ellipse(52% 0% at 50% 119%);
    z-index: 211;
    background: #ccbef6;
    height: 8rem;
    transform: rotate(180deg);
...
@media (min-width: 768px) and (max-width: 999px) {
  ...
  .menu-logo {
    margin-left: 15px; }
  .navbar-toggler-icon {
    background-image: url("data:image/svg+xml;charset=utf8,<svg viewBox=\'0 0 30 30\' xmlns=\'http://www.w3.org/2000/svg\'><path stroke=\'rgba(255,255, 255, 0.9)\' stroke-width=\'2\' stroke-linecap=\'\' stroke-miterlimit=\'10\' d=\'M4 7h22M4 15h22M4 23h22\'/></svg>") !important;
    border-color: #9f80dc !important; } }
...
@media (min-width: 0px) and (max-width: 520px) {
  ...
  .menu {
    ...
    .menu .menu-logo h1 {
      margin: 0;
      font-size: 3.5em; }
    .menu button.navbar-toggler.collapsed {
      position: absolute;
      left: 12px; }
