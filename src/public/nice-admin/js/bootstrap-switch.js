...
(function (a, b) {
  ...
  function c(j, k) {
    ...
    function j(k) {
      var l = this,
          m = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {};c(this, j), this.$element = g(k), this.options = g.extend({}, g.fn.bootstrapSwitch.defaults, this._getElementOptions(), m), this.prevOptions = {}, this.$wrapper = g('<div>', { class: function _class() {
          var o = [];return o.push(l.options.state ? 'on' : 'off'), l.options.size && o.push(l.options.size), l.options.disabled && o.push('disabled'), l.options.readonly && o.push('readonly'), l.options.indeterminate && o.push('indeterminate'), l.options.inverse && o.push('inverse'), l.$element.attr('id') && o.push('id-' + l.$element.attr('id')), o.map(l._getClass.bind(l)).concat([l.options.baseClass], l._getClasses(l.options.wrapperClass)).join(' ');
        } }), this.$container = g('<div>', { class: this._getClass('container') }), this.$on = g('<span>', { html: this.options.onText, class: this._getClass('handle-on') + ' ' + this._getClass(this.options.onColor) }), this.$off = g('<span>', { html: this.options.offText, class: this._getClass('handle-off') + ' ' + this._getClass(this.options.offColor) }), this.$label = g('<span>', { html: this.options.labelText, class: this._getClass('label') }), this.$element.on('init.bootstrapSwitch', this.options.onInit.bind(this, k)), this.$element.on('switchChange.bootstrapSwitch', function () {
    ...
    }return f(j, [{ key: 'setPrevOptions', value: function value() {
        this.prevOptions = e({}, this.options);
      } }, { key: 'state', value: function value(l, m) {
      ...
      } }, { key: 'toggleState', value: function value(l) {
      ...
      } }, { key: 'size', value: function value(l) {
      ...
      } }, { key: 'inverse', value: function value(l) {
        return 'undefined' == typeof l ? this.options.inverse : this.options.inverse === !!l ? this.$element : this.toggleInverse();
      } }, { key: 'toggleInverse', value: function value() {
        this.$wrapper.toggleClass(this._getClass('inverse'));var l = this.$on.clone(!0),
            m = this.$off.clone(!0);return this.$on.replaceWith(m), this.$off.replaceWith(l), this.$on = m, this.$off = l, this.options.inverse = !this.options.inverse, this.$element;
      } }, { key: 'onColor', value: function value(l) {
      ...
      } }, { key: 'offColor', value: function value(l) {
      ...
      } }, { key: 'onText', value: function value(l) {
      ...
      } }, { key: 'offText', value: function value(l) {
      ...
      } }, { key: 'labelWidth', value: function value(l) {
      ...
      } }, { key: 'baseClass', value: function value() {
        return this.options.baseClass;
      } }, { key: 'wrapperClass', value: function value(l) {
      ...
      } }, { key: 'radioAllOff', value: function value(l) {
        if ('undefined' == typeof l) return this.options.radioAllOff;var m = !!l;return this.options.radioAllOff === m ? this.$element : (this.options.radioAllOff = m, this.$element);
      } }, { key: 'onInit', value: function value(l) {
      ...
      } }, { key: 'onSwitchChange', value: function value(l) {
        ...
        var l = this.$element.closest('form');return l.length && l.off('reset.bootstrapSwitch').removeData('bootstrap-switch'), this.$container.children().not(this.$element).remove(), this.$element.unwrap().unwrap().off('.bootstrapSwitch').removeData('bootstrap-switch'), this.$element;
      } }, { key: '_getElementOptions', value: function value() {
      ...
      } }, { key: '_width', value: function value() {
        var l = this,
            m = this.$on.add(this.$off).add(this.$label).css('width', ''),
            n = 'auto' === this.options.handleWidth ? Math.round(Math.max(this.$on.width(), this.$off.width())) : this.options.handleWidth;return m.width(n), this.$label.width(function (o, p) {
      ...
      } }, { key: '_containerPosition', value: function value() {
        var l = this,
            m = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.options.state,
            n = arguments[1];this.$container.css('margin-left', function () {
          var o = [0, '-' + l._handleWidth + 'px'];return l.options.indeterminate ? '-' + l._handleWidth / 2 + 'px' : m ? l.options.inverse ? o[1] : o[0] : l.options.inverse ? o[0] : o[1];
        });
        ...
        };if (this.$wrapper.is(':visible')) return void m();var n = window.setInterval(function () {
          if (l.$wrapper.is(':visible')) return m(), window.clearInterval(n);
        }, 50);
      } }, { key: '_elementHandlers', value: function value() {
        var l = this;return this.$element.on({ 'setPreviousOptions.bootstrapSwitch': this.setPrevOptions.bind(this), 'previousState.bootstrapSwitch': function previousStateBootstrapSwitch() {
      ...
      } }, { key: '_handleHandlers', value: function value() {
        var l = this;return this.$on.on('click.bootstrapSwitch', function (m) {
      ...
      } }, { key: '_labelHandlers', value: function value() {
        var l = this;this.$label.on({ click: function click(o) {
            o.stopPropagation();
            ...
            if (null != l._dragStart) {
              var p = (o.pageX || o.originalEvent.touches[0].pageX) - l._dragStart;o.preventDefault(), p < -l._handleWidth || 0 < p || (l._dragEnd = p, l.$container.css('margin-left', l._dragEnd + 'px'));
            }
            ...
            if (l._dragStart) {
              if (o.preventDefault(), l.options.animate && l.$wrapper.addClass(l._getClass('animate')), l._dragEnd) {
                var p = l._dragEnd > -(l._handleWidth / 2);l._dragEnd = !1, l.state(l.options.inverse ? !p : p);
              } else l.state(!l.options.state);l._dragStart = !1;
            }
          }, 'mouseleave.bootstrapSwitch': function mouseleaveBootstrapSwitch() {
            l.$label.trigger('mouseup.bootstrapSwitch');
          } });
      } }, { key: '_externalLabelHandler', value: function value() {
        var l = this,
            m = this.$element.closest('label');m.on('click', function (n) {
          n.preventDefault(), n.stopImmediatePropagation(), n.target === m[0] && l.toggleState();
        });
      } }, { key: '_formHandler', value: function value() {
        var l = this.$element.closest('form');l.data('bootstrap-switch') || l.on('reset.bootstrapSwitch', function () {
      ...
      } }, { key: '_getClass', value: function value(l) {
        return this.options.baseClass + '-' + l;
      } }, { key: '_getClasses', value: function value(l) {
    ...
    for (var l = arguments.length, m = Array(1 < l ? l - 1 : 0), n = 1; n < l; n++) {
      ...
      var q = g(p),
          ...
          s = r || new h(p, j);return r || q.data('bootstrap-switch', s), 'string' == typeof j ? s[j].apply(s, m) : o;
    }, this);
