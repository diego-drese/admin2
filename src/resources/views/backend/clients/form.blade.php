<div class="col-md-12 form-group {{$errors->has('active') ? 'has-error' : ''}}">
...
<div class="col-md-12 form-group {{$errors->has('cellphone') ? 'has-error' : ''}}">
...
<div class="col-md-12 form-group {{$errors->has('cnpj') ? 'has-error' : ''}}">
...
<div class="col-md-12 form-group {{$errors->has('social_reason') ? 'has-error' : ''}}">
...
<div class="col-md-12 form-group {{$errors->has('fantasy_name') ? 'has-error' : ''}}">
...
<div class="col-md-12 form-group {{$errors->has('state_register') ? 'has-error' : ''}}">
