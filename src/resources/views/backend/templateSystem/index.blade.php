                        ...
                        <table class="table table-bordered" role="grid" aria-describedby="file_export_info">
                            ...
                            <tr>
                                ...
                                <td class="actions-table">
                                    <a href="{{route('admin.template-system.edit', ['id' => $tpl->id])}}" class="btn btn-xs btn-secondary" role="button" aria-pressed="true">
                                        Editar
                                    </a>
                                    <form action="{{route('admin.template-system.destroy', ['id' => $tpl->id])}}" method="POST">
                                        @method('DELETE')
                                        @csrf
