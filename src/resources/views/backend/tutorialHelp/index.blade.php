                        ...
                        <table class="table table-bordered" role="grid" aria-describedby="file_export_info">
                            ...
                            <tr>
                                ...
                                <td class="actions-table">
                                    <a href="{{route('admin.tutorial-help.edit', ['id' => $tuto->id])}}" class="btn btn-xs btn-secondary" role="button" aria-pressed="true">
                                        Editar
                                    </a>
                                    <form action="{{route('admin.tutorial-help.destroy', ['id' => $tuto->id])}}" method="POST">
                                        @method('DELETE')
                                        @csrf
