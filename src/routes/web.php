...
Route::group(['prefix' => $prefix_url,  'middleware' => ['web', 'auth', 'Negotiate\Admin\Http\Middleware\MiddlewareAdmin']], function() {
    ...
    Route::get('/users/create','Negotiate\Admin\Http\Controllers\UserController@create')->name('admin.users.create')->where(['iconAdmin'=>'fa-plus-square','menuAdmin'=> "Criação de usuários", 'parentRouteNameAdmin' => 'admin.users.index', 'nameAdmin'=>'User Create', 'isDefaultAdmin'=>'1']);
    ...
    Route::get('/profiles/create','Negotiate\Admin\Http\Controllers\ProfilesController@create')->name('admin.profiles.create')->where(['iconAdmin'=>'fa-plus-square', 'menuAdmin'=> "Criação de perfis", 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Profile Create', 'isDefaultAdmin'=>'1']);
    ...
    Route::get('/resources/create','Negotiate\Admin\Http\Controllers\ResourcesController@create')->name('admin.resources.create')->where(['iconAdmin'=>'fa-plus-square', 'menuAdmin'=> "Criação de recursos",'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Resource Create', 'isDefaultAdmin'=>'1']);
    ...
    Route::get('/clients/create', 'Negotiate\Admin\Http\Controllers\ClientController@create')->name('admin.client.create')->where(['iconAdmin'=>'fa-plus-square', 'menuAdmin'=> "Cadastro de clientes", 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client Create', 'isDefaultAdmin'=>'1']);
