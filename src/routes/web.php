...
Route::group(['prefix' => $prefix_url,  'middleware' => ['web', 'auth', 'Negotiate\Admin\Http\Middleware\MiddlewareAdmin']], function() {
    ...
    Route::get('/notifications','Negotiate\Admin\Http\Controllers\NotificationsController@index')->name('admin.notifications.index')->where(['iconAdmin'=>'fas fa-exclamation-circle', 'menuAdmin'=> "Notifications", 'parentRouteNameAdmin' => 'System Admin', 'nameAdmin'=>'Notification Listing', 'isDefaultAdmin'=>'1']);
    Route::get('/notifications/create','Negotiate\Admin\Http\Controllers\NotificationsController@create')->name('admin.notifications.create')->where(['iconAdmin'=>'fas fa-plus-square',  'parentRouteNameAdmin' => 'admin.notifications.index', 'nameAdmin'=>'Notification Add form']);
    ...
    Route::get('/notifications/{id}','Negotiate\Admin\Http\Controllers\NotificationsController@edit')->name('admin.notifications.edit')->where(['iconAdmin'=>'fas fa-pencil-square-o',  'parentRouteNameAdmin' => 'admin.notifications.index', 'nameAdmin'=>'Notification edit form']);
    Route::post('/notifications/{id}','Negotiate\Admin\Http\Controllers\NotificationsController@update')->name('admin.notifications.update')->where(['iconAdmin'=>'fas fa-pencil-square-o',  'parentRouteNameAdmin' => 'admin.notifications.index', 'nameAdmin'=>'Notification save edit']);
