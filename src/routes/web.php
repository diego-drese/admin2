...
Route::group(['prefix' => $prefix_url,  'middleware' => ['web', 'auth', 'Oka6\Admin\Http\Middleware\MiddlewareAdmin']], function() {
    ...
    Route::get('/users/{user}','Oka6\Admin\Http\Controllers\UserController@edit')->name('admin.users.edit')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.users.index', 'nameAdmin'=>'User Edit']);
    Route::post('/users/{id}','Oka6\Admin\Http\Controllers\UserController@update')->name('admin.users.update')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.users.index', 'nameAdmin'=>'User Update']);
    ...
    Route::get('/profiles/{profile}','Oka6\Admin\Http\Controllers\ProfilesController@edit')->name('admin.profiles.edit')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Profile Edit']);
    Route::post('/profiles/{id}','Oka6\Admin\Http\Controllers\ProfilesController@update')->name('admin.profiles.update')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Profile Update']);
    ...
    Route::get('/plans/{id}','Oka6\Admin\Http\Controllers\PlansController@edit')->name('admin.plans.edit')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Profile Edit']);
    Route::post('/plans/{id}','Oka6\Admin\Http\Controllers\PlansController@update')->name('admin.plans.update')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Profile Update']);
    ...
    Route::get('/tutorial-help/{id}','Oka6\Admin\Http\Controllers\TutorialHelpController@edit')->name('admin.tutorial-help.edit')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Tutorial Edit']);
    Route::post('/tutorial-help/{id}','Oka6\Admin\Http\Controllers\TutorialHelpController@update')->name('admin.tutorial-help.update')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Tutorial Update']);
    Route::delete('/tutorial-help/{id}','Oka6\Admin\Http\Controllers\TutorialHelpController@destroy')->name('admin.tutorial-help.destroy')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.profiles.index', 'nameAdmin'=>'Tutorial Delete']);
...
//    Route::post('/blog/update-or-destroy-category','Oka6\Admin\Http\Controllers\BlogController@updateOrDestroyCategory')->name('admin.blog.updateOrDestroyCategory')->where(['iconAdmin'=>'fa-rss',  'parentRouteNameAdmin' => 'admin.blog.updateOrDestroyCategory', 'nameAdmin'=>'Blog updateOrDestroyCategory',]);
    ...
    Route::delete('/template-system/{id}','Oka6\Admin\Http\Controllers\TemplateSystemController@destroy')->name('admin.template-system.destroy')->where(['iconAdmin'=>'fa-edit', 'nameAdmin'=>'Template Delete']);
    ...
    Route::get('/resources/{profile}','Oka6\Admin\Http\Controllers\ResourcesController@edit')->name('admin.resources.edit')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.resources.index', 'nameAdmin'=>'Resource Edit']);
    Route::post('/resources/{id}','Oka6\Admin\Http\Controllers\ResourcesController@update')->name('admin.resources.update')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.resources.index', 'nameAdmin'=>'Resource Update']);
    ...
    Route::post('/clients/search-user', 'Oka6\Admin\Http\Controllers\ClientController@searchUser')->name('admin.client.search.user')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client search user']);
    Route::get('/clients/{id}', 'Oka6\Admin\Http\Controllers\ClientController@edit')->name('admin.client.edit')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client Edit']);
    Route::post('/clients/{id}', 'Oka6\Admin\Http\Controllers\ClientController@update')->name('admin.client.update')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client Update']);
    Route::get('/clients/{id}/user/get', 'Oka6\Admin\Http\Controllers\ClientController@userGet')->name('admin.client.user.get')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client user get']);
    Route::post('/clients/{id}/user/save/{idUser?}', 'Oka6\Admin\Http\Controllers\ClientController@userSave')->name('admin.client.user.save')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client user save']);
    Route::get('/clients/{id}/payment-request/get', 'Oka6\Admin\Http\Controllers\ClientController@paymentRequest')->name('admin.client.payment.request.get')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client Payment request']);
    Route::get('/clients/{id}/payment-current/get', 'Oka6\Admin\Http\Controllers\ClientController@paymentCurrent')->name('admin.client.payment.current.get')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client Payment Current']);
    Route::get('/clients/{id}/wallet-transactions/get', 'Oka6\Admin\Http\Controllers\ClientController@walletTransaction')->name('admin.client.wallet.transaction.get')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.client.index', 'nameAdmin'=>'Client Wallet Transaction']);
    ...
    Route::get('/notifications/{id}','Oka6\Admin\Http\Controllers\NotificationsController@edit')->name('admin.notifications.edit')->where(['iconAdmin'=>'fas fa-edit',  'parentRouteNameAdmin' => 'admin.notifications.index', 'nameAdmin'=>'Notification edit form']);
    Route::post('/notifications/{id}','Oka6\Admin\Http\Controllers\NotificationsController@update')->name('admin.notifications.update')->where(['iconAdmin'=>'fas fa-edit',  'parentRouteNameAdmin' => 'admin.notifications.index', 'nameAdmin'=>'Notification save edit']);
...
Route::group(['prefix' => $prefix_url,  'middleware' => ['web', 'auth']], function() {
    ...
    Route::get('/profile','Oka6\Admin\Http\Controllers\UserController@viewUserProfile')->name('admin.users.form-profile')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.users.index', 'nameAdmin'=>'Profile Edit user']);
    Route::post('/profile','Oka6\Admin\Http\Controllers\UserController@updateUserProfile')->name('admin.users.update-profile')->where(['iconAdmin'=>'fa-edit', 'parentRouteNameAdmin' => 'admin.users.index', 'nameAdmin'=>'Profile Edit user']);
