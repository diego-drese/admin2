  ...
  t = t && t.hasOwnProperty("default") ? t.default : t;var e = function () {
    ...
    var n = t.isArray(o.items) ? o.items.map(function (t) {
      var e = "string" == typeof t ? t : t.value || "",
          ...
          i = "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) ? t.option : void 0;return '<a class="dropdown-item" href="#" ' + ('data-value="' + e + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) + ' role="listitem" aria-label="' + t + '">' + n + "</a>";
    }).join("") : o.items;e.html(n).attr({ "aria-label": o.title });
  }),
      p = o('<div class="dropdown-menu note-check" role="list">', function (e, o) {
    var n = t.isArray(o.items) ? o.items.map(function (t) {
      var e = "string" == typeof t ? t : t.value || "",
          n = o.template ? o.template(t) : t;return '<a class="dropdown-item" href="#" data-value="' + e + '" role="listitem" aria-label="' + t + '">' + b(o.checkClassName) + " " + n + "</a>";
    }).join("") : o.items;e.html(n).attr({ "aria-label": o.title });
  }),
    ...
    return "<" + (e = e || "i") + ' class="' + t + '"/>';
      ...
      y = { editor: n, toolbar: i, editingArea: r, codable: s, editable: a, statusbar: l, airEditor: c, airEditable: d, buttonGroup: u, dropdown: h, dropdownButtonContents: function dropdownButtonContents(t) {
      return t;
    }, dropdownCheck: p, palette: f, dialog: m, popover: g, icon: b, checkbox: v, options: {}, button: function button(t, e) {
