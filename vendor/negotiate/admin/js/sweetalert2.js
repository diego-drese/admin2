...
(function (e, t) {
  ...
  function e(e) {
    ...
    var e = Ae.innerParams.get(this),
        t = Ae.domCache.get(this);e.showConfirmButton || (V(t.confirmButton), !e.showCancelButton && V(t.actions)), O([t.popup, t.actions], k.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.cancelButton.disabled = !1;
  }function n(e) {
    e.inputValidator || Object.keys(Ee).forEach(function (t) {
    ...
    }), e.target && ("string" != typeof e.target || document.querySelector(e.target)) && ("string" == typeof e.target || e.target.appendChild) || (g("Target parameter is not valid, defaulting to \"body\""), e.target = "body");var t,
        n = N(),
      ...
      r[s].style.backgroundColor = a;
        ...
        p = Y(),
        m = G(),
        f = X();if (e.titleText ? l.innerText = e.titleText : e.title && (l.innerHTML = e.title.split("\n").join("<br />")), "string" == typeof e.backdrop ? M().style.background = e.backdrop : !e.backdrop && L([document.documentElement, document.body], k["no-backdrop"]), e.html ? ie(e.html, d) : e.text ? (d.textContent = e.text, T(d)) : V(d), e.position in k ? L(i, k[e.position]) : (g("The \"position\" parameter is not valid, defaulting to \"center\""), L(i, k.center)), e.grow && "string" == typeof e.grow) {
      var b = "grow-" + e.grow;b in k && L(i, k[b]);
    }"function" == typeof e.animation && (e.animation = e.animation.call()), e.showCloseButton ? (m.setAttribute("aria-label", e.closeButtonAriaLabel), T(m)) : V(m), t.className = k.popup, e.toast ? (L([document.documentElement, document.body], k["toast-shown"]), L(t, k.toast)) : L(t, k.modal), e.customClass && L(t, e.customClass);var y = z(),
      ...
      var o = document.createElement("li");if (L(o, k.progresscircle), o.innerHTML = t, n === v && L(o, k.activeprogressstep), y.appendChild(o), n !== e.progressSteps.length - 1) {
        var i = document.createElement("li");L(i, k.progressline), e.progressStepsDistance && (i.style.width = e.progressStepsDistance), y.appendChild(i);
      }
    })) : V(y);for (var w = H(), C = 0; C < w.length; C++) {
      V(w[C]);
    }if (e.type) {
      var x = !1;for (var A in B) {
        if (e.type === A) {
          x = !0;break;
        }
      }if (!x) return h("Unknown alert type: " + e.type), !1;var E = t.querySelector("." + k.icon + "." + B[e.type]);T(E), e.animation && L(E, "swal2-animate-" + e.type + "-icon");
      ...
      L([c, p], k.styled), e.confirmButtonColor && (c.style.backgroundColor = e.confirmButtonColor), e.cancelButtonColor && (p.style.backgroundColor = e.cancelButtonColor);var P = window.getComputedStyle(c).getPropertyValue("background-color");c.style.borderLeftColor = P, c.style.borderRightColor = P;
    } else O([c, p], k.styled), c.style.backgroundColor = c.style.borderLeftColor = c.style.borderRightColor = "", p.style.backgroundColor = p.style.borderLeftColor = p.style.borderRightColor = "";ie(e.footer, f), !0 === e.animation ? O(t, k.noanimation) : L(t, k.noanimation), e.showLoaderOnConfirm && !e.preConfirm && g("showLoaderOnConfirm is set to true, but preConfirm is not defined.\nshowLoaderOnConfirm should be used together with preConfirm, see usage example:\nhttps://sweetalert2.github.io/#ajax-request");
  }function o() {
    if ("undefined" != typeof window) {
      "undefined" == typeof Promise && h("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)");for (var e = arguments.length, t = Array(e), n = 0; n < e; n++) {
        t[n] = arguments[n];
      }if ("undefined" == typeof t[0]) return h("SweetAlert2 expects at least 1 attribute!"), !1;Le = this;var o = Object.freeze(this.constructor.argsToParams(t));Object.defineProperties(this, { params: { value: o, writable: !1, enumerable: !0 } });var i = this._main(this.params);Ae.promise.set(this, i);
    }
    ...
    null === t && (t = Function.prototype);var i = Object.getOwnPropertyDescriptor(t, n);if (void 0 === i) {
      var a = Object.getPrototypeOf(t);return null === a ? void 0 : e(a, n, o);
    }if ("value" in i) return i.value;var r = i.get;return void 0 === r ? void 0 : r.call(o);
  },
      d = function d(e, t) {
    ...
    for (var t = [], n = 0; n < e.length; n++) {
      ...
      f = function f(e) {
    var t = [];return "undefined" != typeof Map && e instanceof Map ? e.forEach(function (e, n) {
      t.push([n, e]);
    ...
    if (A.previousActiveElement && A.previousActiveElement.focus) {
      var e = window.scrollX,
          t = window.scrollY;A.previousActiveElement.focus(), "undefined" != typeof e && "undefined" != typeof t && window.scrollTo(e, t);
    }
  },
      M = function M() {
    return document.body.querySelector("." + k.container);
      ...
      I = function I(e) {
    var t = M();return t ? t.querySelector("." + e) : null;
  },
      N = function N() {
    return I(k.popup);
  },
      H = function H() {
    var e = N();return e.querySelectorAll("." + k.icon);
  },
      W = function W() {
    return I(k.title);
  },
    ...
    var e = Array.prototype.slice.call(N().querySelectorAll("[tabindex]:not([tabindex=\"-1\"]):not([tabindex=\"0\"])")).sort(function (e, t) {
      return (e = parseInt(e.getAttribute("tabindex")), t = parseInt(t.getAttribute("tabindex")), e > t) ? 1 : e < t ? -1 : 0;
        ...
        t = Array.prototype.slice.call(N().querySelectorAll("a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex=\"0\"], [contenteditable], audio[controls], video[controls]"));return m(e.concat(t));
  },
      $ = function $() {
    ...
    return "undefined" == typeof window || "undefined" == typeof document;
      ...
      oe = function oe(e) {
    var t = M();if (t && (t.parentNode.removeChild(t), O([document.documentElement, document.body], [k["no-backdrop"], k["has-input"], k["toast-shown"]])), te()) return void h("SweetAlert2 requires document to initialize");var n = document.createElement("div");n.className = k.container, n.innerHTML = ne;var o = "string" == typeof e.target ? document.querySelector(e.target) : e.target;o.appendChild(n);var i = N(),
        a = U(),
        r = _(a, k.input),
        s = _(a, k.file),
        ...
        p = _(a, k.textarea);i.setAttribute("role", e.toast ? "alert" : "dialog"), i.setAttribute("aria-live", e.toast ? "polite" : "assertive"), e.toast || i.setAttribute("aria-modal", "true");var m = function m() {
      ...
      ie = function ie(e, t) {
    if (!e) return V(t);if ("object" === ("undefined" == typeof e ? "undefined" : a(e))) {
      if (t.innerHTML = "", 0 in e) for (var n = 0; n in e; n++) {
        t.appendChild(e[n].cloneNode(!0));
      } else t.appendChild(e.cloneNode(!0));
    } else if (e) t.innerHTML = e;else ;T(t);
  },
      ae = function () {
    if (te()) return !1;var e = document.createElement("div"),
      ...
      re = function re() {
    var e = "ontouchstart" in window || navigator.msMaxTouchPoints;if (e) return 0;var t = document.createElement("div");t.style.width = "50px", t.style.height = "50px", t.style.overflow = "scroll", document.body.appendChild(t);var n = t.offsetWidth - t.clientWidth;return document.body.removeChild(t), n;
  },
      se = function se() {
    ...
    if (E(document.body, k.iosfix)) {
      var e = parseInt(document.body.style.top, 10);O(document.body, k.iosfix), document.body.style.top = "", document.body.scrollTop = -1 * e;
    }
  },
      ce = {},
      pe = function pe(e, t) {
    var n = M(),
        o = N();if (o) {
      null !== e && "function" == typeof e && e(o), O(o, k.show), L(o, k.hide), clearTimeout(o.timeout), ee() || (R(), window.onkeydown = ce.previousWindowKeyDown, ce.windowOnkeydownOverridden = !1);var i = function i() {
    ...
    return -1 !== fe.indexOf(e);
      ...
      be = function be(e) {
    for (var t in e) {
      ge(t) || g("Unknown parameter \"" + t + "\""), he(t) && y("The parameter \"" + t + "\" is deprecated and will be removed in the next major release.");
    }
  },
      ye = {},
      ve = [],
    ...
    "undefined" != typeof ve[e] && ve.splice(e, 1);
      ...
      xe = function xe() {
    var e = N();e || Oe(""), e = N();var t = J(),
        n = Q(),
        o = Y();T(t), T(n), L([e, t], k.loading), n.disabled = !0, o.disabled = !0, e.setAttribute("data-loading", !0), e.setAttribute("aria-busy", !0), e.focus();
  },
      ke = Object.freeze({ isValidParameter: ge, isDeprecatedParameter: he, argsToParams: function argsToParams(e) {
      var t = {};switch (a(e[0])) {case "string":
          ["title", "html", "type"].forEach(function (n, o) {
            void 0 !== e[o] && (t[n] = e[o]);
          });break;case "object":
          s(t, e[0]);break;default:
          return h("Unexpected type of argument! Expected \"string\" or \"object\", got " + a(e[0])), !1;}return t;
    ...
    }, close: pe, closePopup: pe, closeModal: pe, closeToast: pe, isVisible: function isVisible() {
      return !!N();
    }, clickConfirm: function clickConfirm() {
      return Q().click();
    }, clickCancel: function clickCancel() {
      return Y().click();
    }, getPopup: N, getTitle: W, getContent: U, getImage: K, getButtonsWrapper: function getButtonsWrapper() {
    ...
    }, insertQueueStep: we, deleteQueueStep: Ce, showLoading: xe, enableLoading: xe, fire: function fire() {
    ...
    var Be = 0;window.Symbol = function (e) {
      ...
      }return o.prototype = { delete: function _delete(t) {
          delete t[this[e]];
        }, get: function get(t) {
          return t[this[e]];
        }, has: function has(t) {
    ...
    var o = M(),
        i = N();null !== t && "function" == typeof t && t(i), e ? (L(i, k.show), L(o, k.fade), O(i, k.hide)) : O(i, k.fade), T(i), o.style.overflowY = "hidden", ae && !E(i, k.noanimation) ? i.addEventListener(ae, function e() {
      ...
      Pe = Object.freeze({ hideLoading: t, disableLoading: t, getInput: function getInput(e) {
      var t = Ae.innerParams.get(this),
          n = Ae.domCache.get(this);return (e = e || t.input, !e) ? null : "select" === e || "textarea" === e || "file" === e ? _(n.content, k[e]) : "checkbox" === e ? n.popup.querySelector("." + k.checkbox + " input") : "radio" === e ? n.popup.querySelector("." + k.radio + " input:checked") || n.popup.querySelector("." + k.radio + " input:first-child") : "range" === e ? n.popup.querySelector("." + k.range + " input") : _(n.content, k.input);
    }, enableButtons: function enableButtons() {
      var e = Ae.domCache.get(this);e.confirmButton.disabled = !1, e.cancelButton.disabled = !1;
    }, disableButtons: function disableButtons() {
      var e = Ae.domCache.get(this);e.confirmButton.disabled = !0, e.cancelButton.disabled = !0;
    }, enableConfirmButton: function enableConfirmButton() {
      var e = Ae.domCache.get(this);e.confirmButton.disabled = !1;
    }, disableConfirmButton: function disableConfirmButton() {
      var e = Ae.domCache.get(this);e.confirmButton.disabled = !0;
    }, enableInput: function enableInput() {
      var e = this.getInput();if (!e) return !1;if ("radio" === e.type) for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"), o = 0; o < n.length; o++) {
        n[o].disabled = !1;
      } else e.disabled = !1;
    }, disableInput: function disableInput() {
      var e = this.getInput();if (!e) return !1;if (e && "radio" === e.type) for (var t = e.parentNode.parentNode, n = t.querySelectorAll("input"), o = 0; o < n.length; o++) {
        n[o].disabled = !0;
      } else e.disabled = !0;
    }, showValidationError: function showValidationError(e) {
      var t = Ae.domCache.get(this);t.validationError.innerHTML = e;var n = window.getComputedStyle(t.popup);t.validationError.style.marginLeft = "-" + n.getPropertyValue("padding-left"), t.validationError.style.marginRight = "-" + n.getPropertyValue("padding-right"), T(t.validationError);var o = this.getInput();o && (o.setAttribute("aria-invalid", !0), o.setAttribute("aria-describedBy", k.validationerror), S(o), L(o, k.inputerror));
    }, resetValidationError: function resetValidationError() {
      var e = Ae.domCache.get(this);e.validationError && V(e.validationError);var t = this.getInput();t && (t.removeAttribute("aria-invalid"), t.removeAttribute("aria-describedBy"), O(t, k.inputerror));
    }, _main: function _main(e) {
      var t = this;be(e);var o = s({}, me, e);n(o), Object.freeze(o), Ae.innerParams.set(this, o);var r = { popup: N(), container: M(), content: U(), actions: J(), confirmButton: Q(), cancelButton: Y(), closeButton: G(), validationError: F(), progressSteps: z() };Ae.domCache.set(this, r);var l = this.constructor;return new Promise(function (e, n) {
        var s = function s(t) {
          ...
          return d("timer");
        }, o.timer));var p = function p() {
          var e = t.getInput();if (!e) return null;switch (o.input) {case "checkbox":
          ...
          var e = t.getInput();e && S(e);
        }, 0);for (var m = function m(e) {
          if (o.showLoaderOnConfirm && l.showLoading(), o.preConfirm) {
            t.resetValidationError();var n = Promise.resolve().then(function () {
          ...
          var i = n || window.event,
              ...
              f = s && (s === e || s.contains(e));switch (i.type) {case "click":
              if (!(c && l.isVisible())) f && l.isVisible() && (t.disableButtons(), d(l.DismissReason.cancel));else if (t.disableButtons(), o.input) {
                var g = p();if (o.inputValidator) {
                  t.disableInput();var h = Promise.resolve().then(function () {
              ...
              } else m(!0);break;default:}
        }, b = r.popup.querySelectorAll("button"), y = 0; y < b.length; y++) {
          b[y].onclick = g, b[y].onmouseover = g, b[y].onmouseout = g, b[y].onmousedown = g;
          ...
          var i = !1;r.popup.onmousedown = function () {
        ...
        }o.reverseButtons ? r.confirmButton.parentNode.insertBefore(r.cancelButton, r.confirmButton) : r.confirmButton.parentNode.insertBefore(r.confirmButton, r.cancelButton);var C = function C(e, t) {
          for (var n = Z(o.focusCancel), i = 0; i < n.length; i++) {
            e += t, e === n.length ? e = 0 : -1 === e && (e = n.length - 1);var a = n[e];if (D(a)) return a.focus();
          }
          ...
          var i = n || window.event;if ("Enter" === i.key && !i.isComposing) {
            if (i.target === t.getInput()) {
              if (-1 !== ["textarea", "file"].indexOf(o.input)) return;l.clickConfirm(), i.preventDefault();
            }
          } else if ("Tab" === i.key) {
        ...
        }), t.enableButtons(), t.hideLoading(), t.resetValidationError(), o.input && L(document.body, k["has-input"]);for (var x = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], B = void 0, A = 0; A < x.length; A++) {
          var E = k[x[A]],
              P = _(r.content, E);if (B = t.getInput(x[A]), B) {
            for (var O in B.attributes) {
              if (B.attributes.hasOwnProperty(O)) {
                var q = B.attributes[O].name;"type" !== q && "value" !== q && B.removeAttribute(q);
              }
            }for (var j in o.inputAttributes) {
              B.setAttribute(j, o.inputAttributes[j]);
            }
          }P.className = E, o.inputClass && L(P, o.inputClass), V(P);
        }var R;switch (o.input) {case "text":case "email":case "password":case "number":case "tel":case "url":
            B = _(r.content, k.input), B.value = o.inputValue, B.placeholder = o.inputPlaceholder, B.type = o.input, T(B);break;case "file":
            B = _(r.content, k.file), B.placeholder = o.inputPlaceholder, B.type = o.input, T(B);break;case "range":
            var M = _(r.content, k.range),
                I = M.querySelector("input"),
                N = M.querySelector("output");I.value = o.inputValue, I.type = o.input, N.value = o.inputValue, T(M);break;case "select":
            var H = _(r.content, k.select);if (H.innerHTML = "", o.inputPlaceholder) {
              var W = document.createElement("option");W.innerHTML = o.inputPlaceholder, W.value = "", W.disabled = !0, W.selected = !0, H.appendChild(W);
            }R = function R(e) {
              e.forEach(function (e) {
                var t = c(e, 2),
                    n = t[0],
                    i = t[1],
                    a = document.createElement("option");a.value = n, a.innerHTML = i, o.inputValue.toString() === n.toString() && (a.selected = !0), H.appendChild(a);
              }), T(H), H.focus();
            };break;case "radio":
            var U = _(r.content, k.radio);U.innerHTML = "", R = function R(e) {
              e.forEach(function (e) {
                var t = c(e, 2),
                    n = t[0],
                    i = t[1],
                    a = document.createElement("input"),
                    r = document.createElement("label");a.type = "radio", a.name = k.radio, a.value = n, o.inputValue.toString() === n.toString() && (a.checked = !0), r.innerHTML = i, r.insertBefore(a, r.firstChild), U.appendChild(r);
              }), T(U);var t = U.querySelectorAll("input");t.length && t[0].focus();
            };break;case "checkbox":
            var K = _(r.content, k.checkbox),
                z = t.getInput("checkbox");z.type = "checkbox", z.value = 1, z.id = k.checkbox, z.checked = !!o.inputValue;var F = K.getElementsByTagName("span");F.length && K.removeChild(F[0]), F = document.createElement("span"), F.innerHTML = o.inputPlaceholder, K.appendChild(F), T(K);break;case "textarea":
            var Q = _(r.content, k.textarea);Q.value = o.inputValue, Q.placeholder = o.inputPlaceholder, T(Q);break;case null:
            break;default:
            h("Unexpected type of input! Expected \"text\", \"email\", \"password\", \"number\", \"tel\", \"select\", \"radio\", \"checkbox\", \"textarea\", \"file\" or \"url\", got \"" + o.input + "\"");}if ("select" === o.input || "radio" === o.input) {
          var Y = function Y(e) {
            return R(f(e));
      ...
      Le = void 0;o.prototype.then = function (e, t) {
    var n = Ae.promise.get(this);return n.then(e, t);
  }, o.prototype.catch = function (e) {
    var t = Ae.promise.get(this);return t.catch(e);
  }, o.prototype.finally = function (e) {
    var t = Ae.promise.get(this);return t.finally(e);
  }, s(o.prototype, Pe), s(o, ke), Object.keys(Pe).forEach(function (e) {
    o[e] = function () {
      if (Le) {
        var t;return (t = Le)[e].apply(t, arguments);
      }
    };
  }), o.DismissReason = C, o.noop = function () {}, o.version = "7.19.3";var Oe = e(function (e) {
    var t = function (t) {
      function n() {
        return i(this, n), u(this, (n.__proto__ || Object.getPrototypeOf(n)).apply(this, arguments));
      }return d(n, t), r(n, [{ key: "_main", value: function value(e) {
    ...
    }(e);return "undefined" != typeof window && "object" === a(window._swalDefaults) && t.setDefaults(window._swalDefaults), t;
  }(o));return Oe.default = Oe, Oe;
