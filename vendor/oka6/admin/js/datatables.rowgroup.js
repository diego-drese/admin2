...
(function (factory) {
   ...
   */
		_adjustColspan: function _adjustColspan() {
			$('tr.' + this.c.className, this.s.dt.table().body()).find('td').attr('colspan', this._colspan());
		},
   ...
   */
		_rowWrap: function _rowWrap(display, className, level) {
			...
			if ((typeof display === 'undefined' ? 'undefined' : _typeof(display)) === 'object' && display.nodeName && display.nodeName.toLowerCase() === 'tr') {
				row = $(display);
