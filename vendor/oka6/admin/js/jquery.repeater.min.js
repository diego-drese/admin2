...
!function (a) {
  ...
  var b = function b(a) {
    ...
    return m(a, function (a) {
      ...
      o = function o(a, b) {
    var d;return c(a) ? (d = [], g(a, function (a, c, e) {
      b(a, c, e) && d.push(a);
    ...
    var b = function b(a, _b) {
      ...
      var c = a(this),
          d = A({ $: c });return c.is("input, textarea, select") ? "undefined" == typeof b ? d[c.attr("name")].get() : (d[c.attr("name")].set(b), c) : "undefined" == typeof b ? p(d, "get") : (g(b, function (a, b) {
        d[b].set(a);
      }), c);
      ...
      var b = a(this);return p(A({ $: b }), "disable"), b;
    }, a.fn.inputEnable = function () {
      var b = a(this);return p(A({ $: b }), "enable"), b;
    }, a.fn.inputClear = function () {
      var b = a(this);return p(A({ $: b }), "clear"), b;
    };
    ...
    c = c || {};var d;return a(this).each(function () {
      var e = a(this),
          f = c.show || function () {
        a(this).show();
      },
        ...
        return l(k.find("[data-repeater-item]"), c.repeaters);
          ...
          r = l(l(a(this).find("[data-repeater-item]"), c.repeaters).first().find("[data-repeater-delete]"), c.repeaters);c.isFirstItemUndeletable && r && r.remove();var s = function s() {
        var a = k.data("repeater-list");return c.$parent ? c.$parent.data("item-name") + "[" + a + "]" : a;
      },
          t = function t(b) {
        ...
        a && g(a, function (a) {
          ...
          v = function v(b, c, d) {
        b.each(function (b) {
          var e = a(this);e.data("item-name", c + "[" + b + "]"), l(e.find("[name]"), d).each(function () {
            var f = a(this),
                g = f.attr("name").match(/\[[^\]]+\]/g),
                i = g ? h(g).replace(/\[|\]/g, "") : f.attr("name"),
                j = c + "[" + b + "][" + i + "]" + (f.is(":checkbox") || f.attr("multiple") ? "[]" : "");f.attr("name", j), u(d, e, function (d) {
              var e = a(this);v(l(e.find("[data-repeater-item]"), d.repeaters || []), c + "[" + b + "][" + e.find("[data-repeater-list]").first().data("repeater-list") + "]", d.repeaters);
            });
          });
        ...
        var d = function d(e, f, h) {
          if (f || c.defaultValues) {
            var i = {};l(e.find("[name]"), h).each(function () {
              var b = a(this).attr("name").match(/\[([^\]]*)(\]|\]\[\])$/)[1];i[b] = a(this).attr("name");
            ...
            var c = a(this);l(c.find("[data-repeater-item]"), b.repeaters).each(function () {
              var e = c.find("[data-repeater-list]").data("repeater-list");if (f && f[e]) {
                var h = a(this).clone();c.find("[data-repeater-item]").remove(), g(f[e], function (a) {
                  var e = h.clone();d(e, a, b.repeaters || []), c.find("[data-repeater-list]").append(e);
                });
          ...
          x = function x(a) {
        var b = q.clone();w(b, a), c.repeaters && t(b), f.call(b.get(0));
      };d = function d(a) {
        p().remove(), g(a, x);
      }, l(e.find("[data-repeater-create]"), c.repeaters).click(function () {
        x();
      }), k.on("click", "[data-repeater-delete]", function () {
        var b = a(this).closest("[data-repeater-item]").get(0);i.call(b, function () {
