...
mix.babel([
	...
	'src/resources/assets/theme/backend/js/ion.rangeSlider.js',
	'src/resources/assets/theme/backend/js/jquery.inputmask.bundle.min.js',
...
mix.copy('src/resources/assets/theme/backend/img/favicon.png', 'src/public/img');
mix.copy('src/resources/assets/theme/backend/img/sprite-skin-flat.png', 'src/public/img');
